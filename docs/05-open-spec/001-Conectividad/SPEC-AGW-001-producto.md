# SPEC-AGW-001 (open-spec / trazabilidad)
...
HU-002 (Gateway) usa **este** SPEC (§6), no el placeholder fase 2: [SPEC-AGW-002](../../02-producto/agente-gateway/SPEC-AGW-002-ciclo-sql-y-updates.md).
