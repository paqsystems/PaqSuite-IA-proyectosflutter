...
- [x] Modo `AGENTE-GATEWAY` declarado
- [x] `docs/00–06` creados con SPEC/HU/TR trazables
- [x] Orden D10 documentado en `docs/03-historias-usuario/001-Conectividad/README.md`
- [x] Informe ambigüedad en `docs/08-control/`
- [x] Solution `src/` con PaqContracts, PaqGateway, PaqAgent, PaqAgentInstaller
- [x] `VERSION` presente
- [x] `docs/06-operacion/urls-deploy.md` con `https://gateway.paqsuite.com/agent-hub`
- [x] Prompts 05/06/07 actualizados a paths `docs/`
- [x] Nota explícita: trabajo Laravel en repo TANGO
- [x] Sin Tailscale / sin fallback modo agente en plantillas

Cierre: 2026-09-04. Rama `sdd-reformulacion`. **Sin implementación de HU. Sin commit/push.**
