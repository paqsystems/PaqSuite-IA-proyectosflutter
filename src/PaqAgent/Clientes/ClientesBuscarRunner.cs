...
public sealed class ClientesBuscarOutcome
{
...
public sealed class ClientesBuscarRunner
{
    private const int DefaultLimit = 20;
    private const int MaxLimit = 100;

    private readonly IClientesBuscarSpExecutor clientesBuscarSpExecutor;

    public ClientesBuscarRunner(IClientesBuscarSpExecutor clientesBuscarSpExecutor)
    {
        this.clientesBuscarSpExecutor = clientesBuscarSpExecutor;
    }

    public async Task<ClientesBuscarOutcome> RunAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return new ClientesBuscarOutcome
            {
        ...
        try
        {
            ...
            var rows = await clientesBuscarSpExecutor
    ...
    private static ClientesBuscarOutcome Fail(string code, string message) =>
        new()
        {
