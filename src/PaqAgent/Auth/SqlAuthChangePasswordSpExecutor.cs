...
public sealed class SqlAuthChangePasswordSpExecutor : IAuthChangePasswordSpExecutor
{
    public const string StoredProcedureName = "dbo.PAQ_Auth_ChangePassword";
        ...
        CancellationToken cancellationToken)
    {
        ...
        command.Parameters.Add(new SqlParameter("@Codigo", System.Data.SqlDbType.NVarChar, 100) { Value = codigo });
        command.Parameters.Add(new SqlParameter("@PasswordHash", System.Data.SqlDbType.NVarChar, 255)
        {
            Value = passwordHash
        });
