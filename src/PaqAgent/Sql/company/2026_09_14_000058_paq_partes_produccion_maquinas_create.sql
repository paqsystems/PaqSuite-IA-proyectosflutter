CREATE OR ALTER PROCEDURE dbo.PAQ_PartesProduccion_MaquinasCreate
    @Codigo NVARCHAR(20),
    @Nombre NVARCHAR(100),
    @Activa BIT = 1
AS
BEGIN
    ...
    IF EXISTS (
        ...
        WHERE CODIGO_MAQUINA = @codigoNorm
    )
    BEGIN
        SELECT
    ...
    INSERT INTO dbo.PQ_PRD_MAQUINAS (CODIGO_MAQUINA, NOMBRE, ACTIVA)
